...
class Compilation(models.Model):
    name = models.CharField(verbose_name="Подборка",
                            max_length=127, default=None)
...
class Product(models.Model):
    ...
    compilations = models.ManyToManyField(
        Compilation, verbose_name="Участие в подборках")
    manufacter = models.ForeignKey(Manufacter, on_delete=models.PROTECT, default=None)
    cpu = models.ForeignKey(Cpu, on_delete=models.PROTECT, default=None)

    roarCam = models.CharField(verbose_name="Задняя камера", max_length=31, default=None)
    frontCam = models.CharField(verbose_name="Фронтальная камера", max_length=31, default=None)
    ...
    image2 = models.ImageField(verbose_name="Изображение 2", default=None, null=True, blank=True)
    ...
    image3 = models.ImageField(verbose_name="Изображение 3", default=None, null=True, blank=True)
    ...
    image4 = models.ImageField(verbose_name="Изображение 4", default=None, null=True, blank=True)
    ...
    image5 = models.ImageField(verbose_name="Изображение 5", default=None, null=True, blank=True)
